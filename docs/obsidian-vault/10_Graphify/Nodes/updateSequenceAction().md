---
graphify_id: "settings_actions_updatesequenceaction"
...
- `calls` → [[10_Graphify/Nodes/sequenceHasActiveSteps()|sequenceHasActiveSteps()]]
...
- `calls` → [[10_Graphify/Nodes/sequenceInput()|sequenceInput()]]
