---
graphify_id: "crm_actions_updateleadfieldaction"
...
- `calls` → [[10_Graphify/Nodes/EditableLeadField|EditableLeadField]]
- `calls` → [[10_Graphify/Nodes/normalizeEditableLeadValue()|normalizeEditableLeadValue()]]
- `calls` → [[10_Graphify/Nodes/createSupabaseServiceClient()|createSupabaseServiceClient()]]

## Incoming relationships

- [[10_Graphify/Nodes/inline-editable-field.tsx|inline-editable-field.tsx]] → `imports`
