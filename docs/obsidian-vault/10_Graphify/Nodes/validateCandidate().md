---
graphify_id: "workflows_lead_discovery_validatecandidate"
...
- `calls` → [[10_Graphify/Nodes/hasExcludedTerm()|hasExcludedTerm()]]
- `calls` → [[10_Graphify/Nodes/isSuppressed()|isSuppressed()]]
