        ...
        <div className="border-b border-white/8 bg-white/[0.03] p-6 lg:p-7">
          <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-3xl">
              <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-white/40">Shared founder operations inbox</p>
              <h2 className="mt-3 text-2xl font-semibold tracking-[-0.03em] text-white sm:text-[2rem]">Resolve replies with context, urgency, and a clear next action.</h2>
              <p className="mt-3 max-w-2xl text-sm leading-6 text-white/58">
                Unhandled replies, AI suggestions, and human follow-ups are surfaced together so the right conversation gets the right response first.
              </p>
            </div>
