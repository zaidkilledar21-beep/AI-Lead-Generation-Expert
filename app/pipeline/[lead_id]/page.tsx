          ...
          <div>
            ...
            <div className="mt-2">
              <span className="text-xl font-medium text-white/90 leading-snug tracking-tight">
                {pendingDraft ? "Review pending draft" : pendingReview ? "Resolve manual review" : lead.approvedForOutreach ? "Awaiting automation" : "Approve for outreach"}
              </span>
            </div>
          </div>
          <div className="mt-4">
      ...
      {pendingDraft || pendingReview ? (
        <section className="panel mt-6 border border-amber-500/30 bg-amber-500/[0.05] shadow-lg shadow-amber-900/10">
          <div className="panel-header items-start bg-amber-500/[0.02]">
            <div>
              <h2 className="text-amber-100/90 font-semibold tracking-tight">Founder action required</h2>
            ...
            {pendingDraft ? <Badge tone="warning" className="bg-amber-500/20 border-amber-500/30">Draft pending</Badge> : <Badge tone="warning" className="bg-amber-500/20 border-amber-500/30">Manual review</Badge>}
          </div>
